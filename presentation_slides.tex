...
\item \textbf{Improvement:} Over 7x faster updates
\end{itemize}
...
\begin{itemize}
\item $\checkmark$ \textbf{Over 7x faster updates} compared to traditional methods
...
\begin{itemize}
\item Over 7x faster update times
